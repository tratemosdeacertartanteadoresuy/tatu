...
<div class="row-fluid">
  ...
  <div class="span9">
    ...
    <g:hasErrors bean="${userTournamentParticipationInstance}">
      <bootstrap:alert class="alert-error">
        <ul>
          <g:eachError bean="${userTournamentParticipationInstance}" var="error">
            <li
    ...
    <fieldset>
      <g:form method="post" class="form-horizontal" action="update"
              id="${userTournamentParticipationInstance?.id}" >

      <g:hiddenField name="version" value="${userTournamentParticipationInstance?.version}"/>
      <fieldset>
        <f:all bean="userTournamentParticipationInstance"/>
